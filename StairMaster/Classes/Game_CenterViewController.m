...
- (IBAction) submitScore
{
	if(self.currentScore > 0)
	{
        ...
        NSLog(@"current leaderboard: %@",self.currentLeaderBoard);
	}
}
- (IBAction) playGame {
...
//	[window makeKeyAndVisible];
    ...
    Game_CenterAppDelegate *appDelegate = [[Game_CenterAppDelegate alloc] init];
    
    
	Scene *scene = [[Scene node] addChild:[Game node] z:-1];
