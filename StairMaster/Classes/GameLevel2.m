...
@synthesize TheAudio, TheAudio2, TheAudio3, TheAudio4, playButton, pauseButton, powerButton, starburst, level2Button, bomb6,bomb7,bomb8,bomb9,bomb10,Timer, gameCenterManager;
...
- (id)initWithScore:(int)lastScore  {
    ...
    AtlasSprite *dude3 = [AtlasSprite spriteWithRect:CGRectMake(93,16,35,65) spriteManager:spriteManager2];
    // dude3.position = ccp(150,220);
    //  dude3.scale = 2.0f;
   ...
   // AtlasSprite *dude2 = [AtlasSprite spriteWithRect:CGRectMake(424,1,65,79) spriteManager:spriteManager2];
    ...
    //  dude3.scale = 2.0f;
   // dude3.position = ccp(150,220);
 //   [spriteManager2 addChild:dude2 z:4 tag:kDude3];
...
[spriteManager2 addChild:pauseButton z:4 tag:kPause];
    ...
    level2Button = [AtlasSprite spriteWithRect:CGRectMake(336,465,210,40) spriteManager:spriteManager2];
...
//    }
    ...
    NSLog(@"dude3: %f %f",dude3.position.x, dude3.position.y);
	/*AtlasSprite *bonus = (AtlasSprite*)[spriteManager getChildByTag:kBonusStartTag+currentBonusType];
     if(bonus.visible) {
	...
	if(bird_vel.y < 0) {
        ...
        if(dude3.position.y < 50){
            dude3.scale = 2.0f;
        }else{
            dude3.scale = 1.0f;
        }
        
     //   dude3.position = ccp(200,300);
 ...
 /*           [TheAudio stop];
    ...
    dude3.position = bird_pos; 
    NSLog(@"dude: %f %f", dude3.position.x, dude3.position.y);
...
- (void) endOfLevel {
  ...
  /*  isTouchEnabled = YES;
    ...
    if (isAccelerometerEnabled && [[UIAccelerometer sharedAccelerometer]
                                   delegate] == self)
        [[UIAccelerometer sharedAccelerometer] setDelegate:nil]; 
    
    GameLevel3 *gameInstructions = [[GameLevel3 alloc] initWithScore:score];
    
   [[UIAccelerometer sharedAccelerometer] setDelegate:gameInstructions];
