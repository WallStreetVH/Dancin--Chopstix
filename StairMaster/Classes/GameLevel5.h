...
@interface GameLevel5 : Main <AVAudioPlayerDelegate> {
	ccVertex2F bird_pos;
	ccVertex2F bird_vel;
	ccVertex2F bird_acc;	
...
@property(nonatomic, retain) AVAudioPlayer *TheAudio5;
...
@property(nonatomic, retain) AVAudioPlayer *gruntAudio2;
...
@property(nonatomic, retain) AtlasSprite *dude3;
