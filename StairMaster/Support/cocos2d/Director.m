...
#ifdef FAST_FPS_DISPLAY
	FPSLabel = [[LabelAtlas labelAtlasWithString:@"00.0" charMapFile:@"redFont.png" itemWidth:16 itemHeight:24 startCharMap:'.'] retain];
#endif	
}
...
-(void) showFPS
{
	...
	glColor4ub(150,100,256,100);
	glTranslatef(230.0, 90, 0);
